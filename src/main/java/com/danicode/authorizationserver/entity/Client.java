...
public class Client {
    ...
    @ElementCollection(fetch = FetchType.EAGER) // crea la tabla y con eager lo instancia cuando se crea el cliente
    private Set<ClientAuthenticationMethod> authenticationMethods;
    @ElementCollection(fetch = FetchType.EAGER)
    private Set<AuthorizationGrantType> authorizationGrantTypes;
    @ElementCollection(fetch = FetchType.EAGER)
    // seria adecuado hacer @OneTomany / @ManyToOne
    // aqui deberiamos anotar con @ManyToOne entonces nos genera la clave primaria
